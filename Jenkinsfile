        ...
        stage('Deploy') {
            ...
            steps {
                ...
                withCredentials([sshUserPrivateKey(
                    ...
                    sh 'sshpass -Ppassphrase -f ./pass ssh -o StrictHostKeyChecking=no -i ${keyfile} -p ${DEPLOY_PORT} ${userName}@${DEPLOY_HOST} cd \\~/partners-deploy \\&\\& ./scripts/recreate.sh ./partners-api.tar.gz dvladir:partners-api api'
                    sh 'rm ./pass'
                }
            }
        }
